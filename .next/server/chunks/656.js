...
const _chalk = /*#__PURE__*/ _interop_require_default(__webpack_require__(6310));
...
const _requestcookies = __webpack_require__(7766);
const _headers = __webpack_require__(3356);
const _cookies = __webpack_require__(9072);
const _requestasyncstorage = __webpack_require__(9741);
const _actionasyncstorage = __webpack_require__(6899);
const _staticgenerationbailout = __webpack_require__(9665);
const _draftmode = __webpack_require__(8670);
function headers() {
...
let chalk;
if (false) {} else {
    chalk = __webpack_require__(2222);
}
...
const _headers = __webpack_require__(3356);
const _constants = __webpack_require__(418);
function getCookieParser(headers) {
    return function parseCookie() {
        ...
        const { parse: parseCookieFn } = __webpack_require__(7784);
...
function clearPreviewData(res, options = {}) {
    ...
    const { serialize } = __webpack_require__(7784);
...
const _apiutils = __webpack_require__(7430);
...
const _requestcookies = __webpack_require__(7766);
const _cookies = __webpack_require__(9072);
const _draftmodeprovider = __webpack_require__(5195);
...
const _responsehandlers = __webpack_require__(8537);
...
const _cookies = __webpack_require__(4079);
const _nexturl = __webpack_require__(2765);
const _cleanurl = __webpack_require__(1552);
...
const _notfound = __webpack_require__(3693);
...
const _routemodule = __webpack_require__(1073);
const _requestasyncstoragewrapper = __webpack_require__(2991);
const _staticgenerationasyncstoragewrapper = __webpack_require__(428);
const _responsehandlers = __webpack_require__(8537);
const _http = __webpack_require__(9095);
const _patchfetch = __webpack_require__(8550);
const _tracer = __webpack_require__(3250);
const _constants = __webpack_require__(1120);
const _getpathnamefromabsolutepath = __webpack_require__(4694);
const _proxyrequest = __webpack_require__(4065);
const _resolvehandlererror = __webpack_require__(5993);
const _log = /*#__PURE__*/ _interop_require_wildcard(__webpack_require__(4278));
const _autoimplementmethods = __webpack_require__(1944);
const _getnonstaticmethods = __webpack_require__(6865);
const _requestcookies = __webpack_require__(7766);
const _routekind = __webpack_require__(8740);
...
const headerHooks = __webpack_require__(525);
...
const _getnextpathnameinfo = __webpack_require__(2642);
...
const _formatnextpathnameinfo = __webpack_require__(583);
const _gethostname = __webpack_require__(6730);
const _getnextpathnameinfo = __webpack_require__(1970);
const REGEX_LOCALHOST_HOSTNAME = /(?!^https?:\/\/)(127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}|::1|localhost)/;
function parseURL(url, base) {
    return new URL(String(url).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"), base && String(base).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"));
}
...
const _reflect = __webpack_require__(3505);
...
const _cookies = __webpack_require__(4079); //# sourceMappingURL=cookies.js.map
...
const _pathhasprefix = __webpack_require__(8372);
function addLocale(path, locale, defaultLocale, ignorePrefix) {
    // If no locale was given or the locale is the default locale, we don't need
    // to prefix the path.
    if (!locale || locale === defaultLocale) return path;
...
const _addpathprefix = __webpack_require__(599);
const _addpathsuffix = __webpack_require__(7578);
const _addlocale = __webpack_require__(2495);
function formatNextPathnameInfo(info) {
    let pathname = (0, _addlocale.addLocale)(info.pathname, info.locale, info.buildId ? undefined : info.defaultLocale, info.ignorePrefix);
    if (info.buildId || !info.trailingSlash) {
        pathname = (0, _removetrailingslash.removeTrailingSlash)(pathname);
...
const _removepathprefix = __webpack_require__(9528);
const _pathhasprefix = __webpack_require__(8372);
function getNextPathnameInfo(pathname, options) {
    var _options_nextConfig;
    const { basePath, i18n, trailingSlash } = (_options_nextConfig = options.nextConfig) != null ? _options_nextConfig : {};
